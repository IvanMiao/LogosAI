...
const STREAM_STAGE_LABEL: Record<AnalysisStreamStage, string> = {
...
interface AnalysisPanelProps {
  ...
  result: string;
  isLoading: boolean;
  streamStage: AnalysisStreamStage | '';
  error: string;
  hasApiKey: boolean;
...
export function AnalysisPanel({
  ...
  const streamStageLabel = streamStage ? STREAM_STAGE_LABEL[streamStage] : 'Analyzing...';
